...
getwd()
setwd("/Users/raksharamchand/Documents/R/INSEADAnalytics/Exercises/Exerciseset1/")
list.files()
```
...
**Your Answers here:**
<br> 1. This is present in the mytickers variable in the dataSet1 file (where it calls Apple as AAPL)
<br>2. The cumulative returns of the S&P index during this period is `r round(100*sum(StockReturns[,1]),1)`%. The average daily returns of the S&P index during this period is `r round(100*mean(StockReturns[,1]),3)`%;
The standard deviation of the daily returns of the S&P index during this period is `r round(100*sd(StockReturns[,1]),3)`%;
<br>
<br>
...
**Your Answers here:**
<br>1. nrow(StockReturns) = `r nrow(StockReturns)`% <br>
ncol(StockReturns) = `r ncol(StockReturns)`%
<br>
<br>
<br>
2.
...
**Your Answers here:**
<br>1. The start date in the dataSet1 file should be 2001-01-01, startDate = "2001-01-01"
<br>2. We can add more ticker symbols to mytickers = c("SPY", "AAPL", "YHOO") such as mytickers = c("SPY", "AAPL", "YHOO", "GOOG", "MSFT").
<br>
<br>
...
**Your Answers here:**
<br>1. Output = 20 which is the number of data points that was read and written for the stock returns of SPY and AAPL.
<br>
<br>
<br>
